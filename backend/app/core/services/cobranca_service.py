...
from app.db.models.cobranca import CanalCobranca, Cobranca, StatusCobranca, TipoCobranca
from app.db.models.fatura import Fatura, StatusFatura
from app.db.repositories.cobranca import CobrancaRepository
...
class CobrancaService:
    ...
    async def enviar_cobranca(self, cobranca_id: UUID) -> Cobranca | None:
        ...
        try:
            from app.core.services.chatwit_client import ChatwitClient
