...
from app.core.auth.dependencies import get_current_user, get_current_tenant_id
...
async def update_lead_stage(
    ...
    """
    from app.core.services.crm.lead_state_machine import (
...
async def get_lead_stage_history(
    ...
    """
    from app.core.services.crm.lead_state_machine import LeadStateMachine
