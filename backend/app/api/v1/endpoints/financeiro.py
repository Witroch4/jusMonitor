...
from app.core.services.cobranca_service import CobrancaService
from app.core.services.financeiro_service import FinanceiroService
from app.db.engine import get_db
from app.db.models.fatura import Fatura, StatusFatura
from app.db.models.lancamento import Lancamento, TipoLancamento
from app.db.models.user import User
from app.db.repositories.fatura import FaturaRepository
from app.db.repositories.lancamento import LancamentoRepository
from app.schemas.fatura import FaturaListResponse, FaturaResponse, FaturaUpdate
...
async def list_lancamentos(
    ...
    return LancamentoListResponse(
        items=[LancamentoResponse.model_validate(i) for i in items],
        total=total,
        skip=skip,
        limit=limit,
    )
